  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      ...
      <div className="overflow-hidden mb-24">
        <div className="flex gap-6 animate-scroll">
          {[...reviews, ...reviews].map((review, index) => (
            <div
              key={index}
              className="min-w-[300px] bg-white border rounded-xl p-5 shadow-sm"
            >
      ...
      <section className="bg-white py-20 overflow-hidden">
        ...
        >
          {/* ITEM 1 */}
          <div className="min-w-[260px] md:min-w-0 px-6 text-center">
            <Plane className="mx-auto mb-4 h-8 w-8" />
            <h3 className="font-semibold mb-2 tracking-wide">
              WORLDWIDE-SHIPPING
            </h3>
            <p className="text-sm text-gray-600">
              Fast, reliable worldwide delivery to your door
            </p>
          </div>

          {/* ITEM 2 */}
          <div className="min-w-[260px] md:min-w-0 px-6 text-center md:border-l">
            <MessageCircle className="mx-auto mb-4 h-8 w-8" />
            <h3 className="font-semibold mb-2 tracking-wide">
              CUSTOMER SUPPORT
            </h3>
            <p className="text-sm text-gray-600">
              Expert support available 24/7 to help you
            </p>
          </div>
          ...
          <div className="min-w-[260px] md:min-w-0 px-6 text-center md:border-l">
            ...
            <p className="text-sm text-gray-600">
              SSL encrypted checkout with industry-standard security
            </p>
          </div>
        </div>

        {/* ✅ MOBILE AUTO SCROLL CSS */}
        <style>{`
